...
namespace GameSDK {
     ...
     */
    interface GraphApi {
        requestAsync: (path: string, method?: string, params?: Object) => Promise<any>
        initPlatformAsync: () => Promise<any>
        getPlayerASIDAsync: () => Promise<string>
    }

    /**
     * FBInstantExtra payload
     */
     ...
     * A blob of data can be attached to the custom link - game sessions initiated from the link will be able to access the data through FBInstant.getEntryPointData().
     * This data should be less than or equal to 1000 characters when stringified.
     * The provided text and image will be used to generate the link preview, with the game name as the title of the preview.
     ...
     * The returned promise will resolve when the dialog is closed regardless if the user actually shared the link or not.
     *
     ...
     * @throws CLIENT_UNSUPPORTED_OPERATION
     */
    function loadBannerAdAsync(placementID: string, config: BannerAdConfig): Promise<void>
    ...
    /**
     * * have in docs but not have in sdk v7.1.0
     *
     ...
     * This API will be rate-limited when called too frequently.
     * Scores posted using this API should be consistent and comparable across game sessions.
     * For example, if Player A achieves 200 points in a session, and Player B achieves 320 points in a session, those two scores should be generated from activities where the scores are fair to be compared and ranked against each other.
     *
    ...
    interface Tournaments {
        ...
        /**
         * Opens the re-share tournament dialog if the player is currently in a tournament session
         *
    ...
    interface CreateTournamentConfig {
        /**
         * * fix @param title -> tournamentTitle
         * * fix optional -> required
         *
    ...
    /**
     * Represents content used to re-share an Instant Tournament.
     */
    ...
    interface Player {
         ...
         * This is the standard Facebook Application-Scoped ID which is used for all Graph API calls.
    ...
    interface SignedPlayerInfo {
         ...
         * ** request_payload - the requestPayload string you specified when calling GameSDK.player.getSignedPlayerInfoAsync.
         *
    ...
    function showGameRating(): Promise<void>
    ...
    interface SharePayload {
        ...
        /**
         * A blob of data to attach to the share. All game sessions launched from the share will be able to access this blob through GameSDK.getEntryPointData().
         */
        data?: any
         ...
         * * v7.1.0
         *
         * A optional array to set sharing destinations in the share dialog.
         * If not specified all available sharing destinations will be displayed.
         */
        shareDestination?: Array<ShareDestination>
     ...
     * * v7.1.0
     *
     * A parameter that may be applied to a shareAsync operation.
     * This set up sharing destination in the share dialog.
     *
     * 'NEWSFEED' - Enable share to newsfeed option
     *
     * 'GROUP' - Enable share to official game group option.
     * This is only available for games with official game group.
     * To set up official game group, add a page in the game app setting in https://www.developers.facebook.com, and then create a group for the page in https://facebook.com.
     *
    ...
    interface LinkSharePayload {
        /**
         * A base64 encoded image to be shown for the link preview.
         * The image is recommended to either be a square or of the aspect ratio 1.91:1
         */
        image?: string
        /**
         * A text description for the link preview.
         * Recommended to be less than 44 characters
         */
        text?: string
        /**
         * A blob of data to associate with the shared link.
    ...
    /**
     * Represents a custom update for GameSDK.updateAsync.
     */
    interface CustomUpdatePayload {
         ...
         * through GameSDK.getEntryPointData(). Must be less than or equal to 1000 characters when stringified.
         */
        data?: any
    ...
    interface InvitePayload {
         ...
         * * v7.1.0
         *
         * The set of filters to apply to the suggestions. Multiple filters may be applied.
         * If no results are returned when the filters are applied, the results will be generated without the filters.
         */
        filters: Array<InviteFilter>
        /**
         * The set of sections to be included in the dialog.
         * Each section can be assigned a maximum number of results to be returned (up to a maximum of 10).
         * If no max is included, a default max will be applied.
         * Sections will be included in the order they are listed in the array.
         * The last section will include a larger maximum number of results, and if a maxResults is provided, it will be ignored.
         * If this array is left empty, default sections will be used.
         */
        sections: Array<InviteSession>
        /**
     ...
     * The sections will be shown in the order they are included in the array, and the last section will contain as many results as possible.
     */
    interface InviteSession {
        ...
        /**
         * Optional maximum number of results to include in the section.
         * This can be no higher than 10.
         * This will be disregarded for the last section, which will contain as many results as possible.
         * If not included, the default maximum number of results for that section type will be used.
         */
        maxResults?: number
    }
     ...
     * * v7.1.0
     *
     * Represents the type of section to include.
     * All section types may include both new and existing contexts and players.
     */
    ...
    /**
     * Represents a leaderboard update for GameSDK.updateAsync.
     */
    ...
    interface IBannerAdSizeOption {
        bannerWidth: number
        bannerHeight: number
    }

    function submitGameResultsAsync(score: number): Promise<boolean>
    function scheduleNotificationAsync(
