...
const { KEY, TEXTURE, FRAME_RATE, END, PREFIX, ZERO_PAD } = ANIMATIONS.RIBBON_B

class RibbonBAnimation extends Phaser.Animations.Animation {
...
export default RibbonBAnimation
