...
const { KEY, TEXTURE, FRAME_RATE, END, PREFIX, ZERO_PAD } = ANIMATIONS.RIBBON_D

class RibbonDAnimation extends Phaser.Animations.Animation {
...
export default RibbonDAnimation
