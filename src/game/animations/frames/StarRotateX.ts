...
const { KEY, TEXTURE, FRAME_RATE, END, PREFIX, ZERO_PAD } = ANIMATIONS.CONFETTI_STAR_X

class StarRotateXAnimation extends Phaser.Animations.Animation {
...
export default StarRotateXAnimation
