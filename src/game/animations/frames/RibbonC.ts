...
const { KEY, TEXTURE, FRAME_RATE, END, PREFIX, ZERO_PAD } = ANIMATIONS.RIBBON_C

class RibbonCAnimation extends Phaser.Animations.Animation {
...
export default RibbonCAnimation
