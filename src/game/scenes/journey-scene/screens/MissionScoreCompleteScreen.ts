...
export default class MissionScoreCompleteScreen extends GameCore.Screen {
    ...
    private createTitle() {
        ...
        Phaser.Display.Align.In.Center(this.buttonClose, this.title, 150, -15)
    ...
    private createTextLevel(): void {
        ...
        Phaser.Display.Align.In.Center(this.textLevel, this.popup, 0, -60)
    }
    ...
    private createTextLevelComplete(): void {
        ...
        Phaser.Display.Align.In.Center(this.textLevelComplete, this.popup, 0, -20)
    }
    ...
    private createButtonBack(): void {
        ...
        this.buttonBack = new Button(this.scene, KEY, FRAME.BUTTON_MINOR, 70, 54)
        ...
        Phaser.Display.Align.In.Center(this.buttonBack, this.popup, -88, 55)
    }
    ...
    private createButtonContinue(): void {
        ...
        this.buttonContinue = new Button(this.scene, KEY, FRAME.BUTTON_GREEN, 172, 54)
        ...
        Phaser.Display.Align.In.Center(this.buttonContinue, this.popup, 37, 55)
    }
    ...
    private checkFinishAllLevel = (): boolean => {
        const state = this.scene.storage.getState()
