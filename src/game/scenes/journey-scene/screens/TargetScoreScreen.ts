...
class TargetScoreScreen extends GameCore.Screen {
    ...
    public open(data: TData): void {
        ...
        const targetScore = this.scene.targetMissionManager.getTargetValue()
    ...
    private createTitle() {
        ...
        const { width, height } = this.titleFrame

        this.titleFrame.setWorldSize(width / imageScale, height / imageScale)
