...
class Footer extends Phaser.GameObjects.Container {
    ...
    constructor(scene: GameScene) {
        ...
        this.setSize(this.scene.gameZone.width, 76)
    ...
    private createDebugButtonNextPieces(): void {
        this.debugButton = new Button(this.scene, KEY, FRAME.BUTTON_DARK_BLUE, 100, 30)
    ...
    public updateUILandscape(): void {
        console.log('footer updateUILandscape')
        this.initPosition()
        // this.updateBg()

        if (this.scene.tutorialManager.isStopped()) {
