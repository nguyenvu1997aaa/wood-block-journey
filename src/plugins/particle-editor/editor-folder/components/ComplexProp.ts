...
class ComplexProp {
    ...
    protected fetchPropValue(): boolean {
        ...
        if (Array.isArray(value)) {
            ...
            this.propValueInput.array = true
            this.propValueInput.value = value[0]
            this.propValueInput.values = value

            return true
        } else if (isNumber(value)) {
            this.propValueInput.composite = false
            this.propValueInput.array = false
    ...
    private createInput(): void {
        ...
        this.valueInput = this.folder.addInput(this.propValueInput, 'value', opt_params)
    ...
    private addValueInput = (value: number): void => {
        const step = this.inputStep
    ...
    private toPropValue() {
        ...
        if (!this.propValueInput.composite) {
            if (this.propValueInput.array) {
                ...
                config = this.propValueInput.value
            }
        } else {
            if (this.propValueInput.random) {
