...
var CONST = require('phaser/const')
var Device = require('phaser/device')
var GetFastValue = require('phaser/utils/object/GetFastValue')
var GetValue = require('phaser/utils/object/GetValue')
var IsPlainObject = require('phaser/utils/object/IsPlainObject')
var PhaserMath = require('phaser/math/')
var NOOP = require('phaser/utils/NOOP')
var DefaultPlugins = require('phaser/plugins/DefaultPlugins')
var ValueToColor = require('phaser/display/color/ValueToColor')
...
var Config = new Class({
    initialize: function Config(config) {
        ...
        /**
         * @const {number} Phaser.Core.Config#loaderRetries - Optional XHR withCredentials value.
         */
        this.loaderRetries = GetValue(config, 'loader.retries', 0)
