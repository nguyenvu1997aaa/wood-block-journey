...
var Clamp = require('phaser/math/Clamp')
var Extend = require('phaser/utils/object/Extend')
...
var Frame = new Class({
    ...
    copy: function (frame) {
        ...
        this.sourceIndex = frame.sourceIndex

        this.cutX = frame.cutX
        this.cutY = frame.cutY
        this.cutWidth = frame.cutWidth
        this.cutHeight = frame.cutHeight
        ...
        this.centerX = frame.centerX
        this.centerY = frame.centerY

        this.rotated = frame.rotated

        this.data = Extend(true, this.data, frame.data)
