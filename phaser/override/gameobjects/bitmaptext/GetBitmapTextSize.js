...
var GetBitmapTextSize = function (src, round, updateOrigin, out) {
    ...
    var lineHeight = src.lineHeight ?? src.fontData.lineHeight
        ...
        for (i = 0; i < textLength; i++) {
            ...
            if (charCode === wordWrapCharCode) {
                ...
                current.w +=
                    glyph.xOffset +
                    glyph.xAdvance +
                    (glyphKerningOffset !== undefined ? glyphKerningOffset : 0)
            }
    ...
    for (i = 0; i < textLength; i++) {
        ...
        var charWidth =
            glyph.xOffset + glyph.xAdvance + (kerningOffset !== undefined ? kerningOffset : 0)
