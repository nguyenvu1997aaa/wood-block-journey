...
var CONST = require('phaser/loader/const')
var CustomSet = require('phaser/structs/Set')
var EventEmitter = require('eventemitter3')
var Events = require('phaser/loader/events')
var FileTypesManager = require('phaser/loader/FileTypesManager')
var GetFastValue = require('phaser/utils/object/GetFastValue')
var PluginCache = require('phaser/plugins/PluginCache')
var SceneEvents = require('phaser/scene/events')
...
var LoaderPlugin = new Class({
    ...
    initialize: function LoaderPlugin(scene) {
         ...
         * @since 3.0.0
         */
        this.maxParallelDownloads = GetFastValue(
            sceneConfig,
            'maxParallelDownloads',
            gameConfig.loaderMaxParallelDownloads
        )
        ...
        this.xhr = XHRSettings(
            ...
            GetFastValue(sceneConfig, 'retries', gameConfig.loaderRetries)
        )
