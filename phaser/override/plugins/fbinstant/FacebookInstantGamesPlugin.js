...
var AdInstance = require('phaser-plugins/fbinstant/src/AdInstance')
var Class = require('phaser/utils/Class')
var DataManager = require('phaser/data/DataManager')
var EventEmitter = require('eventemitter3')
var Leaderboard = require('phaser-plugins/fbinstant/src/Leaderboard')
var Product = require('phaser-plugins/fbinstant/src/Product')
var Purchase = require('phaser-plugins/fbinstant/src/Purchase')
...
var FacebookInstantGamesPlugin = new Class({
    ...
    initialize: function FacebookInstantGamesPlugin(game) {
