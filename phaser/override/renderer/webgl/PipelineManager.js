...
var Class = require('phaser/utils/Class')
var CONST = require('phaser/renderer/webgl/pipelines/const')
var CustomMap = require('phaser/structs/Map')

//  Default Phaser 3 Pipelines
var BitmapMaskPipeline = require('phaser/renderer/webgl/pipelines/BitmapMaskPipeline')
// var GraphicsPipeline = require('phaser/renderer/webgl/pipelines/GraphicsPipeline')
// var LightPipeline = require('phaser/renderer/webgl/pipelines/LightPipeline')
var MultiPipeline = require('phaser/renderer/webgl/pipelines/MultiPipeline')
// var PointLightPipeline = require('phaser/renderer/webgl/pipelines/PointLightPipeline')
// var RopePipeline = require('phaser/renderer/webgl/pipelines/RopePipeline')
// var SinglePipeline = require('phaser/renderer/webgl/pipelines/SinglePipeline')
// var UtilityPipeline = require('phaser/renderer/webgl/pipelines/UtilityPipeline')
...
var PipelineManager = new Class({
    initialize: function PipelineManager(renderer) {
        /**
    ...
    blendFramesAdditive: function (source1, source2, target, strength, clearAlpha) {
        this.setUtility(this.UTILITY_PIPELINE.addShader).blendFramesAdditive(
            source1,
            source2,
            target,
            strength,
